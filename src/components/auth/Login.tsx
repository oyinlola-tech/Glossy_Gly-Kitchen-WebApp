      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gradient-to-br from-amber-50 via-white to-rose-50">
        <div className="w-full max-w-md">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              type="button"
              onClick={() => toast.info('Google sign-in token flow is available via /auth/google API.')}
              className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-amber-500 hover:bg-amber-50 transition-all"
            >
            ...
            <button
              type="button"
              onClick={() => toast.info('Apple sign-in token flow is available via /auth/apple API.')}
              className="flex items-center justify-center px-4 py-3 border-2 border-gray-200 rounded-xl hover:border-amber-500 hover:bg-amber-50 transition-all"
            >
